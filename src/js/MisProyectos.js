...
const MisProyectos=[
  ...
  },
  {
    ...
    bg:'/webp/proyectos/encriptador.webp',
    github:'https://github.com/Alejool/Challenger_ONE.git',
    demo:'https://dashing-wisp-a8978b.netlify.app/',
    info:'Este proyecto es un encriptador básico hecho en HTML, SASS y JS. El objetivo del proyecto es permitir al usuario encriptar mensajes de texto de manera sencilla y segura. Se destaca: gulp 4.2.0, sass 1.62.0',
  ...
  },
  {
    ...
    bg:'/webp/proyectos/bienesraices.webp',
  ...
  },
  {
    ...
    bg:'/webp/proyectos/luna-sol.webp',
    github:'https://github.com/Alejool/sol-luna.git',
    demo:'',
    info:'Creación de un poster sencillo que representa la luna y el sol, utilizando HTML5 y CSS3 para construir un diseño atractivo y elegante. El poster incluye dos poemas alusivos a la luna y al sol, junto con una imagen que representa ambos elementos en una composición equilibrada y estética. Además, se incorporó un grid que representa a cada parte, ya sea luna o sol, lo que ayuda a destacar la individualidad y la importancia de cada uno..',
  },
]
